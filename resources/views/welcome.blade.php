...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            /* background-image: url(..//img/solidgrey.png); */
    ...
    <div class="page-heading2 header-text">
      <div class="container">
        <div class="row">
            ...
            <iframe width="1170" height="800" src="https://datastudio.google.com/embed/reporting/bba97c27-79e2-4d03-88b8-82bd9528da44/page/SNGtC" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
      </div>
    </div>
    
      <img src="{{URL::asset('/img/protomap.png')}}" height='auto' max-width='auto'>
    </div>
<footer>
